            ...
            <div className="w-full text-left space-y-6">
              <div>
                ...
                <p className="font-bold text-neutral-900 text-[15px] tracking-tight">
                  ayushsolanki@gmail.com
                </p>
              </div>

              <div>
                <p className="text-neutral-500 text-[13px] font-medium mb-3">More options</p>
                <a href="#" className="w-full flex items-center justify-center gap-2 border border-neutral-200 bg-white rounded-xl py-3 hover:bg-neutral-50 transition-colors shadow-sm">
