...
import { createThought, getThoughtCategories } from "@/app/actions/thought";
...
export default function NewThoughtPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await createThought(formData);
  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-serif-display font-bold text-neutral-900 tracking-tight">New Thought</h1>
          <p className="text-neutral-500">Write a new reflection, dev note, or idea.</p>
        </div>
      </div>
      ...
      <Card className="rounded-2xl shadow-sm border-neutral-200/60 overflow-hidden">
        <form onSubmit={handleSubmit}>
          <CardHeader className="bg-neutral-50/50 border-b border-neutral-100 pb-6">
            ...
            <CardDescription>Fill in the details for your new thought.</CardDescription>
          </CardHeader>
          <CardContent className="p-6 space-y-8">
            ...
            {success && (
              <div className="p-4 text-sm font-medium text-emerald-600 bg-emerald-50 border border-emerald-100 rounded-xl">
                Thought published successfully! Redirecting...
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <Input 
                  id="title" 
                  name="title" 
                  placeholder="e.g. Why I Switched from PHP to Node.js" 
                  required 
              ...
              <div className="space-y-3">
                ...
                <Input 
                  id="slug" 
                  name="slug" 
                  placeholder="e.g. why-i-switched-to-nodejs" 
                  required 
                  ...
                  {ACCENT_COLORS.map((color) => (
                    <label key={color.value} className="cursor-pointer">
                      <input 
                        ...
                        defaultChecked={color.value === "#ede8ff"}
                      />
