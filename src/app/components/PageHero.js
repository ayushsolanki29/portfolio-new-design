...
export default function PageHero({
  ...
  return (
    <section
      className={`relative flex flex-col items-center justify-center px-5 pt-[120px] sm:pt-[160px] pb-10 sm:pb-12 sm:px-8 lg:px-12 text-center ${className}`}
    >
      <div
        className="nav-aura"
        aria-hidden="true"
      ...
      <h1 className="font-serif-display text-[32px] sm:text-[56px] lg:text-[72px] font-bold text-neutral-950 leading-tight mb-3 sm:mb-4 relative z-10">
        {heading}
      </h1>

      {subtitle && (
        <p className="text-[14px] sm:text-[18px] text-neutral-600 font-medium max-w-2xl mx-auto leading-relaxed relative z-10 px-2">
          {subtitle}
        </p>
      )}
